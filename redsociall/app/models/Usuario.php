...
class Usuario 
{
    ...
    public function getlogueado($datologueado)
    {
        $this->db->query("SELECT * FROM perfil WHERE idUsuario = :usuario");
        $this->db->bind(':usuario', $datologueado);
        return $this->db->register();
    }

    public function getlogueado2($datologueado)
    {
        $this->db->query("SELECT * FROM usuarios WHERE idUsuario = :usuario");
        $this->db->bind(':usuario', $datologueado);
        return $this->db->register();
    }
